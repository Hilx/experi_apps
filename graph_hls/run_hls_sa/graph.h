...
#define HASHTABLE_NUM_BUCKETS 32 // Configuration
// OFFSETS 
...
volatile void bucket_node_write(data_t * m2mem, data_t * m2alloc, data_t * buffer, ptr_t ptr_bucket_node, struct bucket_node_t node);
// keyset operations
